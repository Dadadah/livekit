...
func Test_OnUpstreamRTCP_SeveralTracks(t *testing.T) {
	...
	fixture.sut.TrackUnpublished(context.Background(), livekit.RoomID(room.Sid), livekit.RoomName(room.Name), room.Metadata, partSID, identity, &livekit.TrackInfo{Sid: string(trackID2)}, true)
